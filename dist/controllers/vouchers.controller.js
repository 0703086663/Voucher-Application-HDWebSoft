    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2, h.response(voucherSaved)];
            case 2:
                err_1 = _a.sent();
...
var getVouchers = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Voucher_1.default.find()];
            case 1:
                vouchers = _a.sent();
                return [2, h.response(vouchers)];
            case 2:
                err_2 = _a.sent();
...
var getVoucher = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Voucher_1.default.findById(request.params.id)];
            case 1:
                voucherfound = _a.sent();
                if (voucherfound) {
                    return [2, h.response(voucherfound)];
                }
...
var updateVoucher = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Voucher_1.default.findByIdAndUpdate(request.params.id, request.payload || {}, { new: true })];
            case 1:
                updatedVoucher = _a.sent();
                if (updatedVoucher) {
                    return [2, h.response(updatedVoucher)];
                }
                return [2, h.response().code(404)];
            case 2:
                err_4 = _a.sent();
...
var deleteVoucher = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4, Voucher_1.default.findByIdAndDelete(request.params.id)];
            case 1:
                deletedVoucher = _a.sent();
                if (deletedVoucher) {
                    return [2, h.response(deletedVoucher)];
                }
                return [2, h.response().code(404)];
            case 2:
                err_5 = _a.sent();
